...
plot_list <- list(plot_1, plot_3, plot_2, plot_4)  # plot_3 is now in the second position, plot_2 in the third
...
label_list <- list(
  ...
  create_dynamic_label(filtered_data, test_col = "Biomedical_Test_2", unit_col = "Biomedical_2_Units", is_test = TRUE),  # swapped with plot_2
  create_dynamic_label(filtered_data, drug_col = "Drug_Name_1", drug_unit_col = "Drug_1_Units", is_test = FALSE),        # swapped with plot_3
